import xlrd
from lcctoolkit.mainapp.constants import LEGAL_SYSTEMS
from django.core.management.base import BaseCommand
from lcctoolkit.mainapp.models import Country
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        wb = xlrd.open_workbook(
            "/home/gabriela/Projects/lcct/Country metadata for toolkit.xlsx")
        # wb.sheet_names()
        sh = wb.sheet_by_index(0)

        for i in range(1, 231):
            # print(sh.cell(i, 6).value)
