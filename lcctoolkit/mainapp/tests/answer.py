...
from lcctoolkit.mainapp.serializers import AnswerSerializer
from lcctoolkit.mainapp.tests.taxonomy import create_taxonomy_classication
...
class GetAnswersTest(APITestCase):
    ...
    def test_get_all_answers(self):
        response = self.client.get(reverse('api:answers_list_create'))
    ...
    def test_get_single_answer(self):
        response = self.client.get(
            reverse('api:answers_get_update', args=[self.answer_1.pk]))
    ...
    def test_get_invalid_single_answer(self):
        response = self.client.get(
            reverse('api:answers_get_update', args=[100]),
            expect_errors=True
        )
...
class CreateAnswersTest(APITestCase):
    ...
    def test_create_valid_answer(self):
        response = self.client.post(
            reverse('api:answers_list_create'),
